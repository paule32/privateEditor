...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOK_PAS_END = 267,             /* TOK_PAS_END  */
    TOK_PAS_FILE = 268,            /* TOK_PAS_FILE  */
    TOK_PAS_FOR = 269,             /* TOK_PAS_FOR  */
    TOK_PAS_FORWARD = 270,         /* TOK_PAS_FORWARD  */
    TOK_PAS_FUNCTION = 271,        /* TOK_PAS_FUNCTION  */
    TOK_PAS_GOTO = 272,            /* TOK_PAS_GOTO  */
